  ...
  return (
    ...
    >
      ...
      <div className="flex justify-around w-72">
        <button className="h-14 w-32 rounded-md bg-white text-black" onClick={() => savePerson()}>Salvar</button>
        <button className="h-14 w-32 rounded-md border" onClick={() => cancel()}>Cancelar</button>
      </div>
    </main>
  );
}
